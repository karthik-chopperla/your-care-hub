...
const RoleSelection = () => {
  ...
  const handlePartnerTypeSelection = (serviceType: string) => {
    // Navigate to the service setup form with the selected type
    navigate(`/partner-service-setup?type=${serviceType}`);
  };
