  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-normal focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white border-0 hover:scale-105 shadow-medium hover:shadow-strong",
        urgent: "bg-gradient-urgent text-urgent-foreground hover:scale-105 shadow-medium hover:shadow-strong",
        medical: "bg-primary-light text-primary-dark border border-primary/20 hover:bg-primary hover:text-primary-foreground shadow-soft hover:shadow-medium",
        wellness: "bg-secondary-light text-secondary border border-secondary/20 hover:bg-secondary hover:text-secondary-foreground shadow-soft hover:shadow-medium",
      },
      size: {
